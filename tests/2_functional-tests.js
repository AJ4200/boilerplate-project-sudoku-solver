  ...
  suite("Test POST to POST on api/solve/", () => {
    ...
    test("test POST with invlaid characters", (done) => {
      chai
        ...
        .send({
          puzzle:
            "..9..5.1.85.4....2432......1...69.83.g.....6.62.71...9......1945....4.37.4.3..6.a",
        })
        .end((err, res) => {
          assert.isObject(res.body);
          assert.property(res.body, "error");
    ...
    test("test POST with incorrect length", (done) => {
      chai
        ...
        .send({
          puzzle:
            "..9..5.1.85.4....2432......1...69.83.......6.62.71...9......1945....4.37.4.3..6....",
        })
        .end((err, res) => {
          assert.isObject(res.body);
          assert.property(res.body, "error");
    ...
    test("test POST to solve puzzle that cannot be solved", (done) => {
      chai
        ...
        .send({
          puzzle:
            "..9..5.1.85.4....2432......1...69.83999999.6.62.71...9......1945....4.37.4.3..6..",
        })
        .end((err, res) => {
          assert.isObject(res.body);
          assert.property(res.body, "error");
    ...
    test("check a puzzle placement with invalid characters", (done) => {
      chai
        ...
        .send({
          ...
          coordinate: "A1",
          puzzle:
            "..9..5.1.85.4....2432......1...69.83.9..a..6.62.71...9......1945....4.37.4.3..6..",
        })
        .end((err, res) => {
